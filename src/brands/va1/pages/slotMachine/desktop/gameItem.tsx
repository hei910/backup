...
const SDarkOverlayContainer = styled.div`
    background-color: ${(props) => props.theme.colors.page.common.slotMachine.gameItem.boxShadow};
    width: 100%;
    height: 100%;
    visibility: hidden;
    position: absolute;
...
const SItemContainer = styled.div`
    ...
    overflow: hidden;
    box-shadow: ${(props) => props.theme.colors.page.common.slotMachine.gameItem.boxShadow};
    border-radius: 5px;
