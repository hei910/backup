...
//BELOW: component desktop reference from:  /src/components/desktop/betPanel/betMatchList/football/betTableMainMarket/index.tsx

interface MFootballBetTableMainMarketProps {
...
const MFootballBetTableMainMarket: React.FC<MFootballBetTableMainMarketProps> = ({ convertedData }) => {
...
export default MFootballBetTableMainMarket
