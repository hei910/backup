...
interface MTennisBetTableMainMarketProps {
...
const MTennisBetTableMainMarket: React.FC<MTennisBetTableMainMarketProps> = ({ convertedData }) => {
                        ...
                        <ExpandableHeader
                            ...
                            rightSide={
                                <TableRightSide>
                                    ...
                                    <SHeaderTitle>{t('betPanel.ahfts')}</SHeaderTitle>
                                    <SHeaderTitle>{t('betPanel.oufts')}</SHeaderTitle>
                                </TableRightSide>
                            }>
...
export default MTennisBetTableMainMarket
